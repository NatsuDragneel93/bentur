...
class TodoTourService {
  private db = FirebaseService.database!;
  private collectionName = 'user_todos_tour'; // Collection specifica per i ToDo Tour
  ...
  async getUserCategories(userId: string): Promise<Category[]> {
    try {
      ...
      console.error('Errore nel recupero delle categorie tour:', error);
      throw error;
    }
  }
  ...
  async addCategory(userId: string, title: string): Promise<void> {
    try {
      ...
      console.error('Errore nell\'aggiunta della categoria tour:', error);
      throw error;
    }
  }
  ...
  async updateCategory(categoryId: string, title: string): Promise<void> {
    try {
      ...
      console.error('Errore nell\'aggiornamento della categoria tour:', error);
      throw error;
    }
  }
  ...
  async deleteCategory(categoryId: string): Promise<void> {
    try {
      ...
      console.error('Errore nell\'eliminazione della categoria tour:', error);
      throw error;
    }
  }
  ...
  async addTodo(categoryId: string, text: string): Promise<void> {
    try {
      ...
      console.error('Errore nell\'aggiunta del todo tour:', error);
      throw error;
    }
  }
  ...
  async updateTodo(categoryId: string, todoId: string, updates: Partial<Omit<Todo, 'id' | 'order'>>): Promise<void> {
    try {
      ...
      console.error('Errore nell\'aggiornamento del todo tour:', error);
      throw error;
    }
  }
  ...
  async deleteTodo(categoryId: string, todoId: string): Promise<void> {
    try {
      ...
      console.error('Errore nell\'eliminazione del todo tour:', error);
      throw error;
    }
  }
  ...
  async updateTodoOrder(categoryId: string, todos: Todo[]): Promise<void> {
    try {
      ...
      console.error('Errore nell\'aggiornamento dell\'ordine dei todos tour:', error);
      throw error;
    }
  }
}
...
const todoTourService = new TodoTourService();
